...
- `feeLimit` (optional): Max token amount the user authorizes for gas; if omitted, the chain may use the sender’s token balance as the effective cap (see AltFeeTx spec)
