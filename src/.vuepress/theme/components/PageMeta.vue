  ...
  <footer class="page-meta">
    <div class="footer-box">
      ...
      <div class="footer-box-area">
        ...
        <ul>
          <li>
            <a href="https://github.com/morphism-labs/Morphism-Documentation/pulls" target="_blank" rel="noopener noreferrer">
              <i class="far fa-pencil"></i> Edit this page
            </a>
          </li>
          <li>
            <a href="https://github.com/morphism-labs" target="_blank" rel="noopener noreferrer">
              <i class="far fa-hands-helping"></i> Contribute to Morphism
            </a>
          </li>
        </ul>
      </div>
