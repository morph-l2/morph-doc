                ...
                ($page.headers && $page.headers.length)
                    ? h("div", [
                        ...
                        h("div", { class: "anchor-support-links" }, [
                            h("a", { attrs: { href: "", target: "_blank" } }, [
                                h("div", [
                                    h("i", { attrs: { class: "fab fa-discord" } }),
                                    " Discord community"
                                ])
                            ]),
                            h("a", { attrs: { href: "https://github.com/morphism-labs/Morphism-Documentation/pulls", target: "_blank" } }, [
                                h("div", [
                                    h("i", { attrs: { class: "fab fa-github" } }),
                                    " Make an issue on GitHub"
                                ])
                            ]),
                            h("a", { attrs: { href: "https://github.com/morphism-labs", target: "_blank" } }, [
                                h("div", [
                                    h("i", { attrs: { class: "far fa-hands-helping" } }),
                                    " Contribute to Morphism"
                                ])
                            ]),
                        ])
                    ])
